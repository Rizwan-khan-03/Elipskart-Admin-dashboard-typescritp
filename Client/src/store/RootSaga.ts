...
import { placeOrderSaga, removeCartSaga ,sameProductAddCartSaga} from '../Component/maincomponent/Cart/Reduxx/cartSaga';
...
function* RootSaga() {
    ...
    yield takeEvery(action_type.ADD_SAME_PRODUCT_IN_CART_REQUEST, sameProductAddCartSaga);
