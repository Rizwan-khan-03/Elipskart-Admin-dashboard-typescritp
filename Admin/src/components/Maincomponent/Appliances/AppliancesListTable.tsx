  ...
  return (
    <>
      <Box sx={{ display: 'flex', justifyContent: "space-between", marginBottom: '10px' }}>
        <Title>Appliances Indent</Title>
        <Button variant='outlined' onClick={() => setOpen(true)}>Add Appliances</Button>
      </Box>
      ...
      <Modal
          content={<AppliancesForm setOpen={setOpen} setTableData={setTableData} tableData={tableData} />}
          open={open}
          setOpen={setOpen}
