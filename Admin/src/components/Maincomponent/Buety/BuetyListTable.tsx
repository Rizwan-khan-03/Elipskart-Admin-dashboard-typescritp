...
import { getBuetyList } from '../../../App/Service/service.buety';
...
const TableExample = () => {
  ...
  const handlGetProductList = async () => {
    try {
      ...
      const res: any = await dispatch(getBuetyList({ userId: "6454fa649b0ffa5392ed86ba", isAdmin: true ,categories:'buety'}))
